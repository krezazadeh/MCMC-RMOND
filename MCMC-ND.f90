...
!         mpiifort -O2 MCMC-ND.f90 -o MCMC-ND
!   - Run with desired number of parallel chains:
!         mpirun -np <nchains> ./MCMC-ND
!
! NOTES:
...
program MCMC
    ...
    real(8), parameter :: Rhat_minus_1_tol = 0.001d0
    ...
    initpoint = (/ 3.0d0, 8.7d0 /)
    priormin = (/ 0.01d0, 0.01d0 /)
    priormax = (/ 10.0d0, 20.0d0 /)
    jumpsize = (/ 0.01d0, 0.01d0 /)
...
!     stop
    ...
    do i = 1, max_iter
        ...
        write(10 + rank, "(5e25.16)") 1.0d0, chi2params_new/2.0d0, params_new &
        , Md(dataNGC3198(ndataNGC3198, 1))
...
function chi2NGC3198()
    ...
    do i = 1, ndataNGC3198
        sum = sum + (vND(dataNGC3198(i, 1)) - dataNGC3198(i, 2))**2/ &
        dataNGC3198(i, 3)**2
    end do
